...
<li> The sample distribution must be nearly normal. - This one</li>
</ol>
...
<li> 95% of random samples of size 60 will yield confidence intervals that contain the true average area of houses in Ames, Iowa. </li> - This one
...
params_samp <- samp %>% summarise(samp_mu = mean(area))
```
...
92% of my confidence intervals contain the true population mean. This proportion is not exactly equal to the confidence level,
